...
namespace Project_Akhir
{
    public partial class formRiwayatPemesanan : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT pm.id_pemesanan, pt.nama, pm.tipe_cucian, pm.jenis_cucian, pm.berat, pm.harga, pm.tanggal_masuk, pm.tanggal_keluar, pm.`status` FROM pemesanan pm inner join petugas pt on pt.id_petugas = pm.id_petugas INNER JOIN pelanggan pl on pl.id_pelanggan = pm.id_pelanggan WHERE pl.id_pelanggan = 1;";
